...
public class MonsterHealthBar : MonoBehaviour
{
    ...
    /// 완전히 같은 이유입니다 - 이전 씬의 poolRoot/체력바 인스턴스들은 이미 파괴된 상태이므로, 그 죽은
    /// 참조를 들고 있는 정적 캐시를 비워서 새 씬에서 깨끗하게 다시 만들어지도록 합니다. GameManager가
    /// SceneManager.sceneLoaded를 구독해서 자동으로 호출해줍니다(GameManager.cs 참고).</summary>
